import { getExpandedPostingIndex } from "@/seeds/fixtures/posting-expansion";
import {
  createFixtureId,
...
const BASE_BOOKING_SPECS: BookingSpec[] = [
  {
    index: 1,
    postingIndex: 1,
...
type ExpandedBookingSpecInput = {
  ownerEmail: string;
  publishedOffset: number;
} & Omit<BookingSpec, "postingIndex">;

function createExpandedBookingSpec(
  spec: ExpandedBookingSpecInput,
): BookingSpec {
  return {
    ...spec,
...
const ADDITIONAL_BOOKING_SPEC_INPUTS: ExpandedBookingSpecInput[] = [
  {
    index: 28,
    ownerEmail: "owner5@rentify.local",
    publishedOffset: 0,
    renterEmail: "user9@rentify.local",
    lifecycle: "pending",
    startAt: "2026-08-22T15:00:00.000Z",
    endAt: "2026-08-24T15:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 164,
    contactName: "Talia Moore",
    note: "Short prairie content stay with a simple handoff.",
  },
  {
    index: 29,
    ownerEmail: "owner5@rentify.local",
    publishedOffset: 1,
    renterEmail: "user10@rentify.local",
    lifecycle: "paid_confirmed",
    startAt: "2026-08-25T15:00:00.000Z",
    endAt: "2026-08-27T15:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 92,
    contactName: "Cole Evans",
    note: "Confirmed guest-room stay for a two-day install.",
  },
  {
    index: 30,
    ownerEmail: "owner6@rentify.local",
    publishedOffset: 0,
    renterEmail: "user11@rentify.local",
    lifecycle: "pending",
    startAt: "2026-08-23T14:00:00.000Z",
    endAt: "2026-08-25T14:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 164,
    contactName: "Rhea Singh",
    note: "Requested studio stay for a compact team reset.",
  },
  {
    index: 31,
    ownerEmail: "owner6@rentify.local",
    publishedOffset: 1,
    renterEmail: "user12@rentify.local",
    lifecycle: "approved",
    startAt: "2026-08-26T13:00:00.000Z",
    endAt: "2026-08-28T13:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 92,
    contactName: "Julian Price",
    note: "Approved room booking while travel details are finalized.",
  },
  {
    index: 32,
    ownerEmail: "owner7@rentify.local",
    publishedOffset: 0,
    renterEmail: "user13@rentify.local",
    lifecycle: "pending",
    startAt: "2026-08-24T16:00:00.000Z",
    endAt: "2026-08-26T16:00:00.000Z",
    guestCount: 3,
    dailyPriceAmount: 164,
    contactName: "Mila Reed",
    note: "Waiting on client approval for a production base stay.",
  },
  {
    index: 33,
    ownerEmail: "owner7@rentify.local",
    publishedOffset: 1,
    renterEmail: "user14@rentify.local",
    lifecycle: "paid",
    startAt: "2026-08-29T12:00:00.000Z",
    endAt: "2026-08-31T12:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 92,
    contactName: "Caleb Hughes",
    note: "Paid booking for a warehouse-adjacent overnight run.",
  },
  {
    index: 34,
    ...
    dailyPriceAmount: 164,
    contactName: "Jordan Lee",
    note: "Pending retreat stay for a tasting recap trip.",
  },
  {
    index: 35,
    ownerEmail: "owner8@rentify.local",
    ...
    dailyPriceAmount: 92,
    contactName: "Priya Nair",
    note: "Approved orchard guest room while AV needs are confirmed.",
  },
  {
    index: 36,
    ...
    dailyPriceAmount: 164,
    contactName: "Sam Turner",
    note: "Requested logistics stay for a small border run.",
  },
  {
    index: 37,
    ownerEmail: "owner9@rentify.local",
    ...
    dailyPriceAmount: 92,
    contactName: "Avery Kim",
    note: "Confirmed stay tied to a cross-border event handoff.",
  },
  {
    index: 38,
    ...
    endAt: "2026-08-29T13:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 164,
    contactName: "Leila Brooks",
    note: "Pending industrial studio stay for a builder review.",
  },
  {
    index: 39,
    ownerEmail: "owner10@rentify.local",
    ...
    note: "Approved Hamilton guest room while schedules settle.",
  },
  {
    index: 40,
    ownerEmail: "owner11@rentify.local",
    publishedOffset: 0,
    renterEmail: "user7@rentify.local",
    lifecycle: "approved",
    startAt: "2026-08-28T14:00:00.000Z",
    endAt: "2026-08-30T14:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 164,
    contactName: "Nina Foster",
    note: "Approved heritage-flat booking for a Kingston check-in.",
  },
  {
    index: 41,
    ownerEmail: "owner11@rentify.local",
    publishedOffset: 1,
    renterEmail: "user8@rentify.local",
    lifecycle: "paid_confirmed",
    startAt: "2026-09-10T14:00:00.000Z",
    endAt: "2026-09-12T14:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 92,
    contactName: "Owen Diaz",
    note: "Confirmed stay for a tidy downtown heritage trip.",
  },
  {
    index: 42,
    ...
    dailyPriceAmount: 164,
    contactName: "Talia Moore",
    note: "Final payment failure after a tidehouse checkout attempt.",
  },
  {
    index: 43,
    ownerEmail: "owner12@rentify.local",
    ...
    dailyPriceAmount: 92,
    contactName: "Cole Evans",
    note: "Paid booking for a maritime gear reset trip.",
  },
  {
    index: 44,
    ...
    dailyPriceAmount: 164,
    contactName: "Rhea Singh",
    note: "Payment failed after a coastal market stay request.",
  },
  {
    index: 45,
    ownerEmail: "owner13@rentify.local",
    ...
    dailyPriceAmount: 92,
    contactName: "Julian Price",
    note: "Confirmed guest-room booking for a short boardwalk run.",
  },
  {
    index: 46,
    ...
    dailyPriceAmount: 164,
    contactName: "Mila Reed",
    note: "Declined after a weather-driven Atlantic schedule conflict.",
  },
  {
    index: 47,
    ownerEmail: "owner14@rentify.local",
    ...
    endAt: "2026-09-21T13:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 92,
    contactName: "Caleb Hughes",
    note: "Refunded after an Atlantic stay changed around weather exposure.",
  },
  {
    index: 48,
    ...
    dailyPriceAmount: 164,
    contactName: "Jordan Lee",
    note: "Declined while northern transport logistics were reworked.",
  },
  {
    index: 49,
    ownerEmail: "owner15@rentify.local",
    ...
    dailyPriceAmount: 92,
    contactName: "Priya Nair",
    note: "Cancelled after a northern travel window moved.",
  },
  {
    index: 50,
    ...
    dailyPriceAmount: 164,
    contactName: "Sam Turner",
    note: "Refunded after a remote-ready stay lost a transport link.",
  },
  {
    index: 51,
    ownerEmail: "owner16@rentify.local",
    ...
    endAt: "2026-09-27T14:00:00.000Z",
    guestCount: 2,
    dailyPriceAmount: 92,
    contactName: "Avery Kim",
    note: "Cancelled after a tundra base itinerary shifted late.",
  },
];
