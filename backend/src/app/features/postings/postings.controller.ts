  ...
  private parseSearchPostingsInput(request: Request): SearchPostingsInput {
    ...
    try {
      const query = publicSearchPostingsQuerySchema.parse({
        ...
        city: this.readOptionalQueryParam(url.searchParams, "city"),
        region: this.readOptionalQueryParam(url.searchParams, "region"),
        country: this.readOptionalQueryParam(url.searchParams, "country"),
