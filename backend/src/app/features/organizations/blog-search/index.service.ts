...
// Manages the Elasticsearch index that backs the public organization blog feed:
// versioned concrete indices with read/write aliases for zero-downtime reindex,
// mirroring OrganizationsSearchIndexService with a blog-specific mapping. The
// index carries both draft and published posts (status is a filterable field);
// the public read services filter to published.
export class OrganizationBlogSearchIndexService {
  ...
  async upsertDocument(
    document: OrganizationBlogSearchDocument,
